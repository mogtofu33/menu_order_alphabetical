...
class RoboFile extends \Robo\Tasks {
  ...
  /**
   * Mirror our project or symlink our module/theme in included Drupal.
   *
   * @param bool $forceMirror
   *   (Optional) Flag to force mirror instead of symlink.
   */
  public function prepareFolders($forceMirror = FALSE) {
    ...
    switch($this->ciType) {
      ...
      case "module":
        ...
        if ($forceMirror) {
          $this->mirror($folder, $target, TRUE);
        }
        else {
